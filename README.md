...
- $\textnormal{KDF}$ is Argon2id using 6 GiB memory, 4 lanes, 1 pass, and a
128-bit salt.

As such, $I$ and $J$ are 128 bits each, $K$ is 256 bits, $R$ is 512 bits, and
$S$ is 128 bits.
...
- $I$ and $J$ were 128 bits each, $K$ was 256 bits, $R$ was 512 bits, and $S$
was 256 bits.
...
- $I$ and $J$ were 128 bits each, $K$ was 256 bits, $R$ was 352 bits, and $S$
was 256 bits.
...
- $I$ and $J$ were 128 bits each, $K$ was 128 bits, $R$ was 224 bits, and $S$
was 128 bits.

## Additional Build Targets

Some of the code in `aes_ecb.c`, `argon2.c`, `blake2b.c`, `pi.h`, and `sha3.c`
has been algorithmically generated. To generate the code in those files, first
run:
```
    $ make generate
```
